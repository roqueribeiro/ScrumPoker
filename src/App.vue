  ...
  <v-app id="app" dark>
    <v-navigation-drawer v-model="drawer" temporary fixed app>
      <v-toolbar flat>
        <v-list>
          <v-list-tile>
            <v-list-tile-title class="title">ScrumPoker</v-list-tile-title>
          </v-list-tile>
        </v-list>
      </v-toolbar>
      <v-divider></v-divider>
    ...
    <v-dialog v-model="about" max-width="500px">
      <v-card>
        ...
        <v-card-text>
          ...
          <p>
            <a href="https://github.com/roqueribeiro/ScrumPoker" target="_blank"
              >GitHub</a
            >
          </p>
          <p></p>
          <p>
            <a href="https://codepen.io/roqueribeiro/" target="_blank"
              >CodePen</a
            >
          </p>
          <p>
            <a
              href="https://www.linkedin.com/in/roqueribeirosilva/"
              target="_blank"
              >LinkedIn</a
            >
          </p>
